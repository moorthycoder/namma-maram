...
<div class=\"page\" id=\"page-notes\">\n\
  ...
  <div class=\"scrollable flow-scroll\">\n\
    <div class=\"dimension-fields\"><div><div class=\"field-label\"><i class=\"ti ti-ruler\"></i> Height</div><div class=\"input-with-unit\"><input class=\"field-input normal\" id=\"survey-height\" placeholder=\"Type in feet\"><span class=\"unit-label\" data-unit-type=\"height\">feet</span></div></div><div><div class=\"field-label\"><i class=\"ti ti-circle\"></i> Diameter</div><div class=\"input-with-unit\"><input class=\"field-input normal\" id=\"survey-diameter\" placeholder=\"Type in feet\"><span class=\"unit-label\" data-unit-type=\"diameter\">feet</span></div></div></div>\n\
    <div><div class=\"field-label\"><i class=\"ti ti-notes\"></i> Note</div><textarea class=\"notes-box\" id=\"survey-observations\" placeholder=\"e.g. New shoots visible, no signs of disease...\"></textarea></div>\n\
...
<div class=\"page\" id=\"page-success\">\n\
  <div class=\"success-top\">\n\
    ...
    <div class=\"success-title\">Tree surveyed!</div>\n\
    <div class=\"success-subtitle\">Tree surveyed successfully.</div>\n\
  </div>\n\
  <div class=\"scrollable flow-scroll\">\n\
...
function renderSurveyReview() {
  ...
  if (heightEl) {
    ...
    heightEl.innerHTML = surveyHeight ? 'Height: ' + surveyHeight + ' ' + hu : '<span class="review-empty">No height recorded</span>';
  }
  var diameterEl = document.getElementById('review-diameter');
  if (diameterEl) {
    var du = getUnits('diameter');
    diameterEl.innerHTML = surveyDiameter ? 'Diameter: ' + surveyDiameter + ' ' + du : '<span class="review-empty">No diameter recorded</span>';
  }
