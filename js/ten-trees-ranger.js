...
function goTo(page) {
  ...
  if (['role-login','role-login','ranger-login','ranger-dash','surveyor-login','surveyor-dash','trees','ranger-logs','ranger-month','ranger-covered','admin-login','admin-dash','admin-trees','admin-edit-tree','admin-add-tree','admin-trackers','admin-sponsors','admin-trackers-prospective','admin-sponsors-prospective','ranger-enroll','sponsor-enroll','surveyor-enroll','role-login'].indexOf(page) > -1) sb.classList.add('dark');
...
window.render = {
  init: function () {
    ...
    renderRangerDash();
    renderRecentEntries('recent-entries', 'ten-trees-ranger', 'openProfile');
  }
};
