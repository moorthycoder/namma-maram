...
function initializeRegisterHubNavigation() {
  var pages = ['sponsor.html?hub=register','care-giver.html?hub=register','ten-trees-ranger.html?hub=register','project-leader.html?hub=register','ranger.html?hub=register','surveyor.html?hub=register'];
