...
function applyRoleVisibility() { var role=getCurrentRoleType(); var showCare=true; var showSponsor=true; var showSurvey=true; var showWatch=true; if(role==='sponsor'){ showCare=false; showSponsor=true; showSurvey=false; showWatch=false; } else if(role==='caregiver'){ showCare=true; showSponsor=false; showSurvey=false; showWatch=false; } else if(role==='surveyor'){ showCare=false; showSponsor=false; showSurvey=true; showWatch=false; } else if(role==='ten-trees-ranger'){ showCare=false; showSponsor=false; showSurvey=false; showWatch=true; } else if(role==='project-leader'){ showCare=false; showSponsor=false; showSurvey=false; showWatch=false; } var careBtns=document.querySelectorAll('.add-care-btn, .care-cta'); var sponsorBtns=document.querySelectorAll('.add-sponsor-btn, .sponsor-cta'); var surveyBtns=document.querySelectorAll('.add-survey-btn, .survey-cta'); var watchBtns=document.querySelectorAll('.add-watch-btn, .watch-cta'); console.log('[tree-profile] role ->', role); careBtns.forEach(function(el){ el.style.display=showCare?'':'none'; }); sponsorBtns.forEach(function(el){ el.style.display=showSponsor?'':'none'; }); surveyBtns.forEach(function(el){ el.style.display=showSurvey?'':'none'; }); watchBtns.forEach(function(el){ el.style.display=showWatch?'':'none'; }); if(isOpenedFromDashboardList(role)){ if(role==='caregiver'){ careBtns.forEach(function(el){ el.style.display='none'; }); } else if(role==='sponsor'){ sponsorBtns.forEach(function(el){ el.style.display='none'; }); } else if(role==='surveyor'){ var is_dash_only = typeof isOpenedFromSurveyorDashOnly==='function' ? isOpenedFromSurveyorDashOnly(role) : false; var is_via_filter = (function(){ var p=new URLSearchParams(location.search).get('parent')||''; try{ var g=sessionStorage.getItem('gobackFromTreeProfile')||''; if(g) p+='|'+g; }catch(e){} return p.indexOf('filter.html')!==-1; })(); if(!is_dash_only && !is_via_filter) { surveyBtns.forEach(function(el){ el.style.display='none'; }); } } else if(role==='ten-trees-ranger'){ careBtns.forEach(function(el){ el.style.display='none'; }); sponsorBtns.forEach(function(el){ el.style.display='none'; }); surveyBtns.forEach(function(el){ el.style.display='none'; }); } else { sponsorBtns.forEach(function(el){ el.style.display='none'; }); careBtns.forEach(function(el){ el.style.display='none'; }); surveyBtns.forEach(function(el){ el.style.display='none'; }); watchBtns.forEach(function(el){ el.style.display='none'; }); } } }
