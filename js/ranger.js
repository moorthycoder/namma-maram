...
function confirmDeleteRangerCard() {
  ...
  if (type === 'tree') {
    ...
    try { var login_data = window.__login || storage.get('login') || {}; login_data['tree-login'] = login_data['tree-login'] || {}; login_data['tree-login']['ranger'] = role_cfg; storage.set('login', login_data); window.__login = login_data; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
    ...
    try { var login_data2 = window.__login || storage.get('login') || {}; login_data2['tree-login'] = login_data2['tree-login'] || {}; login_data2['tree-login']['ranger'] = role_cfg2; storage.set('login', login_data2); window.__login = login_data2; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
    ...
    try { var login_data3 = window.__login || storage.get('login') || {}; login_data3['tree-login'] = login_data3['tree-login'] || {}; login_data3['tree-login']['ranger'] = role_cfg3; storage.set('login', login_data3); window.__login = login_data3; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
    var active_el = document.querySelector('.page.active');
    ...
    try { var login_data4 = window.__login || storage.get('login') || {}; login_data4['tree-login'] = login_data4['tree-login'] || {}; login_data4['tree-login']['ranger'] = role_cfg4; storage.set('login', login_data4); window.__login = login_data4; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
    ...
    try { var login_data5 = window.__login || storage.get('login') || {}; login_data5['tree-login'] = login_data5['tree-login'] || {}; login_data5['tree-login']['ranger'] = role_cfg5; storage.set('login', login_data5); window.__login = login_data5; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
    ...
    try { var login_data6 = window.__login || storage.get('login') || {}; login_data6['tree-login'] = login_data6['tree-login'] || {}; login_data6['tree-login']['ranger'] = role_cfg6; storage.set('login', login_data6); window.__login = login_data6; } catch (e) {}
    try { renderRangerStats(); } catch (e) {}
