...
function payTreeBack(){ var dest=window._sponsorPayTreeFrom||sessionStorage.getItem('sponsorPayTreeFrom')||'sponsor-pay-trees'; if(dest==='sponsor-next-due') dest='sponsor-dash'; goTo(dest); try{if(dest==='sponsor-pay-trees')renderSponsorPayTrees(); else if(dest==='sponsor-dash')loadDashboard(); else if(dest==='sponsor-pay-total')renderSponsorPayTotal(); else if(dest==='sponsor-pay-month')renderSponsorPayMonth();}catch(e){} }
// Add tree
