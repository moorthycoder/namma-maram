...
function renderProjectMemberNextDueSingleCard(single_tid) {
  ...
  if (emptyEl) emptyEl.classList.add('hidden'); if (cardEl) cardEl.innerHTML = projectMemberCardHtml(c);
  return true;
}
